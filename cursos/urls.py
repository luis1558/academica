...
from .views import (RegistroUsuarioView, CustomLoginView, ListaCursosView, DetalleCursoView, CrearCursoView, MisCursosView, InscribirCursoView, CustomLogoutView)
